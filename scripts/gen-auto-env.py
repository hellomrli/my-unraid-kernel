...
The auto build now performs a full kernel rebuild: it compiles the ich777
Unraid-patched kernel source (bzImage + in-tree modules) and OpenZFS with the
official toolchain, then repacks the official USB image. The i915 SR-IOV
driver is no longer part of this project.
"""
...
line("ICH777_RELEASE", params.get("ich777_release", ""))
